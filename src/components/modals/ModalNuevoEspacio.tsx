...
/**
 * Modal animado para crear un nuevo espacio (modo admin)
 */
const ModalNuevoEspacio: React.FC<ModalNuevoEspacioProps> = ({ abierto, onCerrar }) => {
  const { agregarEspacio } = useEspacios();
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#004b87] outline-none"
                />
              </div>
              ...
              >
                <Save size={18} />
                {cargando ? "Guardando..." : "Guardar Espacio"}
              </motion.button>
            </form>
          </motion.div>
        </motion.div>
