...
// UI BASE
import EnapPanel from "@/shared/ui/base/Panel";
import FormField from "@/shared/ui/base/FormField";
import FormFieldSelect from "@/shared/ui/base/FormFieldSelect";
import EnapButton from "@/shared/ui/base/Button";
    ...
    <section aria-label="Filtros de reservas">
      <EnapPanel title="Filtros" className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
          ...
          <FormField
            label="Usuario (nombre / email / RUT)"
            inputProps={{
              name: "socioQuery",
