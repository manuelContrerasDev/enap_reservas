// ============================================================
//  ReservaPage.tsx — UX/UI Premium ENAP (Optimizado + Fix Final)
// ============================================================
...
const ReservaPage: React.FC = () => {
  ...
  const TARIFA_LABEL = React.useMemo(() => {
    if (!espacio) return "";
    if (espacio.modalidadCobro === "POR_DIA") return "día";
    if (espacio.modalidadCobro === "POR_NOCHE") return "noche";
    return "persona";
  }, [espacio]);
  ...
  return (
    <main className="flex min-h-[calc(100vh-120px)] flex-col items-center bg-[#F4F7F9] px-6 pt-3 pb-12">
      ...
      <div className="w-full max-w-7xl">
        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <ReservaEspacioCard
            ...
            capacidadExtra={espacio.capacidadExtra}
            tarifaClp={espacio.tarifaClp}
            tarifaLabel={TARIFA_LABEL}
          />

          {/* PANEL DERECHO / FORMULARIO */}
          <form
            // TS FIX: handleSubmit espera SubmitHandler<TFieldValues>,
            // y onSubmit está tipado con ReservaFrontendType → casteamos.
          ...
          >
            ...
            >
              ...
              {/* USO RESERVA + SOCIO PRESENTE / RESPONSABLE */}
              <UsoReservaForm
                register={register}
                watch={watch}
                setValue={setValue}
      ...
      <ModalAsistentes
        ...
        onSave={(lista) => setValue("invitados", lista)}
        initial={invitados}
