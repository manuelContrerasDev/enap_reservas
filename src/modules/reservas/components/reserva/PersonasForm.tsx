// ============================================================
// PersonasForm.tsx — ENAP 2025 (FINAL SYNC)
// ============================================================
...
const PersonasForm: React.FC<Props> = ({
  ...
  const syncInvitados = (nuevaCantidad: number) => {
    if (invitados.length > nuevaCantidad) {
      setValue("invitados", invitados.slice(0, nuevaCantidad), {
        shouldDirty: true,
        shouldValidate: true,
      });
    }
